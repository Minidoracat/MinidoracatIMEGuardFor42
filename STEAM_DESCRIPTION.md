...
[olist]
[*] 訂閱並啟用本 MOD。
[*] 到 [url=https://github.com/Minidoracat/MinidoracatIMEGuardFor42/releases/latest]GitHub Releases[/url] 下載 [b]pz-ime-guard.exe[/b]，執行。它只會在系統匣出現一個小方塊：綠＝英文鍵盤、橘＝打字中已切回你的輸入法、灰＝沒找到 PZ 或已暫停、紅＝系統沒裝英文（美國）鍵盤。
[*] 開遊戲。進遊戲時若工具沒在跑會提醒一次。
[/olist]
